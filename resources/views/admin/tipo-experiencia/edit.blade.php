                                    ...
                                    <div class="p-6 text-gray-900 dark:text-gray-100">
                                        <div class="container mx-auto">
                                            ...
                                            <div class="flex justify-start mb-6">
                                                <a href="{{ route('admin.tipo-experiencia.index') }}"
                                            ...
                                            {{-- Formulario --}}
                                            <form action="{{ route('admin.tipo-experiencia.update', [$tipo->id]) }}" method="POST" class="space-y-6">
                                                @csrf
                                                @method('PUT')
