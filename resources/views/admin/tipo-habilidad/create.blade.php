            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <div class="container mx-auto">
                        ...
                        {{-- Formulario --}}
                        <form action="{{ route('admin.tipo-habilidad.store') }}" method="POST" class="space-y-6">
                            @csrf

                            <h1 class="text-3xl font-bold mb-6 text-center text-blue-600">Formulario de Tipo de Habilidad</h1>
