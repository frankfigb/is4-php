                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <div class="container mx-auto">
                        ...
                        <div class="flex justify-start mb-6">
                            <a href="{{ route('admin.tipo-habilidad.index') }}"
                        ...
                        {{-- Formulario --}}
                        <form action="{{ route('admin.tipo-habilidad.update', $tipo->id) }}" method="POST" class="space-y-6">
                            @csrf
                            @method('PUT')

                            <h1 class="text-3xl font-bold mb-6 text-center text-blue-600">Editar Tipo de Habilidad</h1>
                            ...
                            <div>
                                ...
                                <input type="text"
                                       name="nombre"
                                       id="nombre"
                                       placeholder="Ingrese el nombre del tipo de habilidad"
