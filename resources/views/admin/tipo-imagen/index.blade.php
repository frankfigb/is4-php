                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <div class="container mx-auto p-4">
                        ...
                        <div class="flex justify-start mb-4">
                            <a href="{{ route('admin.tipo-imagen.create') }}"
                        ...
                        <div class="bg-gray-800 rounded-lg shadow-xl p-6">
                            <h1 class="text-3xl font-bold mb-6 text-center text-blue-400">Listado de Tipos de Imagen</h1>
                                        ...
                                        <tr class="hover:bg-gray-700 transition duration-300 ease-in-out">
                                            ...
                                            <td class="px-5 py-5 border-b border-gray-700 text-sm">
                                                <div class="flex space-x-2">
                                                    {{-- Ver --}}
                                                    <a href="{{ route('admin.tipo-imagen.show', $tipo->id) }}"
                                                    ...
                                                    {{-- Editar --}}
                                                    <a href="{{ route('admin.tipo-imagen.edit', $tipo->id) }}"
                                                    ...
                                                    {{-- Eliminar --}}
                                                    <form action="{{ route('admin.tipo-imagen.destroy', $tipo->id) }}"
                                                          method="POST"
